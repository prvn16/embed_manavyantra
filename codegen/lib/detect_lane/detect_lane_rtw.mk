###########################################################################
## Makefile generated for MATLAB file/project 'detect_lane'. 
## 
## Makefile     : detect_lane_rtw.mk
## Generated on : Fri Jan 12 23:08:02 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\detect_lane.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Sumpurn\embed_manavyantra
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\detect_lane.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\codegen\lib\detect_lane;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;C:\Users\KRISHN~1\DOWNLO~1\CUDNN-~1.1\cuda\include
...
DEFINES_STANDARD = -D MODEL=detect_lane -D HAVESTDIO -D USE_RTMODEL
...
SRCS = $(START_DIR)\codegen\lib\detect_lane\detect_lane_initialize.cu $(START_DIR)\codegen\lib\detect_lane\detect_lane_terminate.cu $(START_DIR)\codegen\lib\detect_lane\detect_lane.cu $(START_DIR)\codegen\lib\detect_lane\DeepLearningNetwork.cu $(START_DIR)\codegen\lib\detect_lane\rt_nonfinite.cu $(START_DIR)\codegen\lib\detect_lane\rtGetNaN.cu $(START_DIR)\codegen\lib\detect_lane\rtGetInf.cu $(START_DIR)\codegen\lib\detect_lane\cnn_api.cu
...
OBJS = detect_lane_initialize.obj detect_lane_terminate.obj detect_lane.obj DeepLearningNetwork.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj cnn_api.obj
...
LIBS = C:\Users\KRISHN~1\DOWNLO~1\CUDNN-~1.1\cuda\lib\x64\cudnn.lib
...
{$(START_DIR)\codegen\lib\detect_lane}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\codegen\lib\detect_lane}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
...
{$(START_DIR)\codegen\lib\detect_lane}.cpp.obj :
	$(CPP) $(CPPFLAGS) -o  "$@" "$<"
